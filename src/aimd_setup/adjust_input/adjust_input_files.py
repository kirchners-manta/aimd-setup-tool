...
def cp_cp2kdata_runscript(
    data: dict[str, Any], template_dir: str, project_dir: str
) -> None:
    """Copy the CP2K data files and the runscript to a directory, and edit the runscript according to user input

    *This function is deprecated and will be removed in the future. The CP2k data files do not need to be copied to the project directory as they come with the CP2k software by default. Use `cp_runscript()` instead.*
...
def cp_runscript(data: dict[str, Any], template_dir: str, project_dir: str) -> None:
